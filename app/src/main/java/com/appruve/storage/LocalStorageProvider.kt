...
class LocalStorageProvider(val context: Context) {
    ...
    fun queryRoots(projection: Array<String>?): Cursor {
        ...
        row.add(DocumentsContract.Root.COLUMN_ICON, android.R.drawable.ic_menu_recent_history)
    ...
    @Throws(FileNotFoundException::class)
    fun createDocument(parentDocumentId: String, mimeType: String,
    ...
    @Throws(FileNotFoundException::class)
    fun openDocumentThumbnail(documentId: String, sizeHint: Point,
        ...
        return AssetFileDescriptor(
            ParcelFileDescriptor.open(tempFile,
            ParcelFileDescriptor.MODE_READ_ONLY), 0,
            AssetFileDescriptor.UNKNOWN_LENGTH)
    }

    @Throws(FileNotFoundException::class)
    fun queryChildDocuments(parentDocumentId: String, projection: Array<String>?,
    ...
    @Throws(FileNotFoundException::class)
    fun queryDocument(documentId: String, projection: Array<String>?): Cursor {
        // Create a cursor with either the requested fields, or the default
        // projection if "projection" is null.
        val result = MatrixCursor(projection ?: DEFAULT_DOCUMENT_PROJECTION)
    ...
    private fun includeFile(result: MatrixCursor, file: File) {
        ...
        // Document.COLUMN_ICON can be a resource terminalId identifying a custom icon.
    ...
    @Throws(FileNotFoundException::class)
    fun getDocumentType(documentId: String): String {
